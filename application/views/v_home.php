    ...
    <header>
      <div class="pp-header">
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container"><a href="<?php echo base_url(); ?>"><img
                src="<?php echo base_url(); ?>assets/images/favicon.png" alt="Logo"></a><a class="navbar-brand"
              href="<?php echo base_url(); ?>">Photo Perfect</a>
